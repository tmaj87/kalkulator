<ul id="form_tabs" class="nav nav-tabs" role="tablist">
    <li><span class="navbar-brand" style="margin-left: 40px">Waga (gramy)</span></li>
    <li role="presentation"><a href="#olej" aria-controls="settings" role="tab" data-toggle="tab">Oleje</a></li>
